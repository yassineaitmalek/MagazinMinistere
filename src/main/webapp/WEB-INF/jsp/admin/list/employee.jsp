...
<html>
	...
	<div id='cssmenu'>
        ...
        <h3 align="center">La Liste des Employees</h3>
      	...
      	<table  cellspacing="0" border="1" class="fl-table">
      		...
      		<tbody>
      		 <c:forEach items="${emps}" var="e">
                    ...
                    <td><a  style='text-decoration:none;' href= "/dashboard/admin/list/employee/upchs/${e.email}"	>chef ser</a></td>
                  	<td><a  style='text-decoration:none;' href= "/dashboard/admin/list/employee/del/${e.email}"		>supprimer</a></td>
