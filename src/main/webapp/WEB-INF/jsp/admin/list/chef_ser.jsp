...
<html>
	...
	<div id='cssmenu'>
        ...
        <h3 align="center">La Liste des Chefs Services</h3>
      	...
      	<table  cellspacing="0" border="1" class="fl-table">
      		...
      		<tbody>
      		 <c:forEach items="${sers}" var="e">
                    ...
                    <td><a  style='text-decoration:none;' href= "/dashboard/admin/list/chef_ser/upchd/${e.email}"	>chef div</a></td>
                  	<td><a  style='text-decoration:none;' href= "/dashboard/admin/list/chef_ser/del/${e.email}"		>supprimer</a></td>
