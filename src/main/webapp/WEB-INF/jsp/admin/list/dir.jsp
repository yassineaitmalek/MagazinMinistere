...
<html>
	...
	<div id='cssmenu'>
        ...
        <h3 align="center">La Liste des Directeurs</h3>
      		...
      		<tbody>
      		 <c:forEach items="${sers}" var="e">
                    ...
                    <td>	${e.tel}		</td>
                  	...
                  	<td><a  style='text-decoration:none;' href= "/dashboard/admin/list/dir/del/${e.email}"		>supprimer</a></td>
