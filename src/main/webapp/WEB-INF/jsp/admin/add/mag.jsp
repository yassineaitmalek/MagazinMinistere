...
<html>
	...
	<div id='cssmenu'>
		...
		<br><br> <br><br>
		 ...
		 <form method="post" action="/dashboard/admin/add/mag/process">

            <table class="t"  width="75%" height="50%" bgcolor="white" align="center">

                    <tr>
                        <td colspan="2" align="center">
                            <h3 for="matricule">Nom Magazin :  </h3>
                     ...
                     <tr>
                        <td colspan="2" align="center">
                            <h3 for="niveau">Nom Direction : </h3>
                            <select  name="nom_dir" size="1" class="selection" required>
