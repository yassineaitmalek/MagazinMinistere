...
<html>
    ...
    ${suc}
		...
		<br><br> <br><br>
		 ...
		 <form method="post" action="/dashboard/magasinier/bone/process">
            ...
            <table class="t"  width="75%" height="50%" bgcolor="white" align="center">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <h3 for="matricule">Libilé :  </h3>
                         	<select  name="a" size="1" class="selection" required>
                                            
                                            <option></option>
                                            <c:forEach items="${arts}" var="d">
	     										<option >${d}</option>
											</c:forEach> 
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <h3 for="matricule">Fournisseur :  </h3>
                        	<select  name="four" size="1" class="selection" required>
                                            
                                            <option></option>
                                            <c:forEach items="${four}" var="d">
	     										<option >${d}</option>
											</c:forEach> 
                   ...
                   <tr>
					    ...
					    <tr>
                        <td colspan="2" align="center">
                            <h3 for="matricule">Prix unité :  </h3>
                           <input type="text" placeholder="Prix" name="prixu" required autofocus class="box" >
